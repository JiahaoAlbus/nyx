# NYX Repository Map for Whitepaper v2

Purpose
- Provide a complete inventory of protocol documentation and code artifacts as inputs to Whitepaper v2.

Scope
- All docs, implementation modules, evidence tests, conformance assets, demos, and execution ops artifacts in the repository.
...
- `README.md` — Operations — Title: NYX Testnet 0.1.
- `CONTRIBUTING.md` — Operations — Title: Contributing to NYX.
- `SECURITY.md` — Operations — Title: Security Policy.
- `docs/AUDIT_CHECKLIST_TESTNET_0_1.md` — Operations — Title: Audit Checklist — NYX Testnet 0.1.
- `docs/AUDIT_CHECKLIST_TESTNET_0_2.md` — Operations — Title: Audit Checklist — Testnet 0.2.
- `docs/AUDIT_PACK_Q5.md` — Operations — Title: Audit Pack Q5.
...
- `docs/DEX_V1_ROUTER_BLUEPRINT.md` — Normative Spec — Title: DEX v1 Router Blueprint (F0).
...
- `docs/INVARIANT_MAP_DEX_V1.md` — Normative Spec — Title: DEX v1 Invariant Map.
- `docs/MAINNET_LAUNCH_CHECKLIST.md` — Operations — Title: Mainnet Launch Checklist.
- `docs/NYX_Q3_IMMUTABLE_RULES.md` — Normative Spec — Title: NYX Q3 Immutable Rules.
- `docs/PHASE2_PLAN.md` — Ecosystem/Platform — Title: Phase-2 Plan (Post Testnet 0.1).
- `docs/POSITIONING_ONE_PAGER.md` — Ecosystem/Platform — Title: NYX Positioning (One Pager).
- `docs/Q3_INTERFACES.md` — Ecosystem/Platform — Title: Q3 Interfaces (Preview).
...
- `docs/REFERENCE_CLIENT_SPEC.md` — Normative Spec — Title: Reference Client v1 Spec.
- `docs/RELEASE_NOTES_Q5_RC.md` — Operations — Title: Release Notes Q5 RC.
...
- `docs/TESTNET_0_1_RUNBOOK.md` — Operations — Title: NYX Testnet 0.1 Runbook.
...
- `docs/break-glass.md` — Normative Spec — Title: Break-Glass Procedure.
- `docs/engineering-foundation.md` — Normative Spec — Title: Engineering Foundation.
- `docs/execution/Q6_BOUNTY_LAUNCH_EVIDENCE.md` — Operations — Title: Q6 Bounty Launch Evidence.
- `docs/execution/Q6_CLOSEOUT_REPORT.md` — Operations — Title: Q6 Closeout Report.
- `docs/execution/Q6_DISCLOSURE_INBOX_TEST.md` — Operations — Title: Q6 Disclosure Inbox Test.
- `docs/execution/Q6_DRYRUN_1_REPORT.md` — Operations — Title: Q6 Dry Run 1 Report.
- `docs/execution/Q6_EVIDENCE_LEDGER_TEMPLATE.md` — Operations — Title: Q6 Evidence Ledger Template.
- `docs/execution/Q6_EXECUTION_PLAN.md` — Operations — Title: Q6 Execution Plan.
- `docs/execution/Q6_FINAL_STATE.md` — Operations — Title: Q6 Final State.
- `docs/execution/Q6_INCIDENT_DRILL_REPORT.md` — Operations — Title: Q6 Incident Drill Report.
- `docs/execution/Q6_KEY_CEREMONY_V1_EVIDENCE.md` — Operations — Title: Q6 Key Ceremony v1 Evidence.
- `docs/execution/Q6_LIVE_RELEASE_REPORT.md` — Operations — Title: Q6 Live Release Report.
- `docs/execution/Q6_OPS_HARDENING_REPORT.md` — Operations — Title: Q6 Ops Hardening Report.
- `docs/execution/Q6_PATCHLOG_1.md` — Operations — Title: Q6 Patchlog 1.
- `docs/execution/Q6_PROVENANCE_PACK.md` — Operations — Title: Q6 Provenance Pack.
- `docs/execution/Q6_PUBLIC_USAGE_CONTRACT.md` — Operations — Title: Q6 Public Usage Contract.
- `docs/execution/Q6_RELEASE_NOTES_MAINNET.md` — Operations — Title: Q6 Release Notes (Mainnet).
- `docs/execution/Q6_RELEASE_NOTES_RC.md` — Operations — Title: Q6 Release Notes (RC).
- `docs/execution/Q6_RELEASE_WINDOW_PLAN.md` — Operations — Title: Q6 Release Window Plan.
- `docs/execution/Q6_SECURITY_GATE_REPORT.md` — Operations — Title: Q6 Security Gate Report.
- `docs/execution/Q6_SIGNING_AUTHZ_MATRIX.md` — Operations — Title: Q6 Signing Authorization Matrix.
- `docs/ops/week2_acceptance_report.md` — Operations — Title: Week 2 Acceptance Report.
- `docs/week1-plan.md` — Normative Spec — Title: week1-plan.md.

## Conformance Assets (Repo Root)
- `conformance/README.md` — Normative Spec — Title: Conformance System.
...
- `conformance/rules/README.md` — Normative Spec — Title: Conformance Rules Index.
...
## Implementation Modules (Packages)
...
- `packages/l0-reputation/src/l0_reputation/interfaces.py` — Implementation — Interface or protocol definitions (no implementation).
...
- `packages/l2-private-ledger/src/l2_private_ledger/interfaces.py` — Implementation — Interface or protocol definitions (no implementation).
...
- `packages/q3-interfaces/src/q3_interfaces/interfaces.py` — Ecosystem/Platform — Interface or protocol definitions (no implementation).
...
## Execution Operations Artifacts
- `docs/execution/Q6_BOUNTY_LAUNCH_EVIDENCE.md` — Operations — Title: Q6 Bounty Launch Evidence.
- `docs/execution/Q6_CLOSEOUT_REPORT.md` — Operations — Title: Q6 Closeout Report.
- `docs/execution/Q6_DISCLOSURE_INBOX_TEST.md` — Operations — Title: Q6 Disclosure Inbox Test.
- `docs/execution/Q6_DRYRUN_1_REPORT.md` — Operations — Title: Q6 Dry Run 1 Report.
...
## Whitepaper v2 Inputs
### What v1 already covers (must be referenced, not duplicated)
- DEX v0 and Router v1 blueprint and invariants: `docs/DEX_V1_BLUEPRINT.md`, `docs/DEX_V1_ROUTER_BLUEPRINT.md`.
- Invariant evidence mapping: `docs/INVARIANT_MAP_DEX.md`, `docs/INVARIANT_MAP_DEX_V1.md`.
- Change control and sealed baseline policy: `docs/CHANGE_CONTROL.md`.
- Security case and disclosure process: `docs/DEX_SECURITY_CASE.md`, `docs/SECURITY_DISCLOSURE_PROCESS.md`.
- Reference client contract: `docs/REFERENCE_CLIENT_SPEC.md`.

### What v2 must add (out-of-scope in v1)
- Ecosystem-level platform narrative and external integration boundaries beyond the repository scope.
- Exchange and liquidity ecosystem positioning beyond the DEX v0/v1 protocol rules.
- Application domain commitments beyond deterministic client and demo evidence.

### Implemented facts that can be cited
- DEX and Router state transitions: `packages/l3-dex/src/l3_dex/kernel.py`, `packages/l3-router/src/l3_router/kernel.py`.
