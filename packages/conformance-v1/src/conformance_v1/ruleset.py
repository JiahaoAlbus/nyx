...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        rule_id="Q4-DEX-01",
        adversary_class=("External Hackers",),
        attack_vector="fee skip on dex action",
        surface="DEX/Economic",
        severity="BLOCKER",
        rationale="DEX mutations must always enforce non-zero fee.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-DEX-02",
        adversary_class=("External Hackers",),
        attack_vector="pool state tamper",
        surface="DEX/Protocol Logic",
        severity="HIGH",
        rationale="Tampered pool state must fail replay validation.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-DEX-03",
        adversary_class=("External Hackers",),
        attack_vector="receipt tamper",
        surface="DEX/Protocol Logic",
        severity="HIGH",
        rationale="Receipt tampering must fail replay validation.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-DEX-04",
        adversary_class=("External Hackers",),
        attack_vector="replay mutation",
        surface="DEX/Protocol Logic",
        severity="HIGH",
        rationale="Replay must reject wrong pre-state.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-DEX-05",
        adversary_class=("Internal Malicious Actors",),
        attack_vector="account semantics injection",
        surface="DEX/Protocol Logic",
        severity="HIGH",
        rationale="DEX receipts must not carry account semantics.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-DEX-06",
        adversary_class=("External Hackers",),
        attack_vector="boundary abuse attempt",
        surface="DEX/Protocol Logic",
        severity="HIGH",
        rationale="DEX rejects oversized or invalid amounts.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q4-BRIDGE-01",
        adversary_class=("Internal Malicious Actors",),
        attack_vector="adapter trust attempt",
        surface="Bridge/Integration",
        severity="HIGH",
        rationale="Adapters must not be trusted as authority.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        ...
        attack_vector="on off shortcut attempt",
        surface="OnOff/Integration",
        severity="HIGH",
        rationale="On/off integrations must not enable shortcuts.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
)
