...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        rule_id="Q8-PATH-01",
        adversary_class=("External Hackers",),
        attack_vector="path traversal attempt",
        surface="Gateway/API",
        severity="HIGH",
        rationale="Artifact access must reject traversal and uncontrolled paths.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q9-COPY-01",
        adversary_class=("Platform-Level Adversaries",),
        attack_vector="preview copy overreach",
        surface="Client/UI",
        severity="HIGH",
        rationale="User-facing copy must not claim live status or access semantics.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
        rule_id="Q9-EVIDENCE-01",
        adversary_class=("External Hackers",),
        attack_vector="evidence contract drift",
        surface="Client/Evidence",
        severity="HIGH",
        rationale="Evidence fields and ordering must remain stable.",
        detection=DETECTION_RUNTIME,
        repro_command=REPRO_COMMAND,
    ),
    Rule(
